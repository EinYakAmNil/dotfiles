...
"<-->
"fast shebangs
nnoremap ,bash ggO#!/bin/bash<Esc>:w<CR>:e<CR><C-o>
...
autocmd FileType plaintex	nnoremap <buffer> <F5> :w<CR>:!xelatex % > /dev/null 2>&1 &<CR><CR>
...
autocmd FileType tex	nnoremap <buffer> <F5> :w<CR>:!clear<CR>:!xelatex % > /dev/null 2>&1 &<CR><CR>
